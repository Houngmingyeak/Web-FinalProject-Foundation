        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 border-b border-gray-200 dark:border-gray-700 pb-8">
          ...
          <div className="md:pl-10">
            ...
            <ul className="space-y-2">
              <li className="hover:text-blue-600 dark:hover:text-blue-400 cursor-pointer transition">Blog</li>
              <li className="hover:text-blue-600 dark:hover:text-blue-400 cursor-pointer transition">Career</li>
              <li className="hover:text-blue-600 dark:hover:text-blue-400 cursor-pointer transition">Contact</li>
              <li className="hover:text-blue-600 dark:hover:text-blue-400 cursor-pointer transition">Press</li>
              <li className="hover:text-blue-600 dark:hover:text-blue-400 cursor-pointer transition">Follow Us</li>
            </ul>
          </div>
