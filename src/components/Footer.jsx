            ...
            <form className="max-w-sm mx-auto mt-4">
              ...
              <div className="relative">
                <input
                  type="search"
                  id="search"
                  className="block w-full p-3 ps-9 bg-neutral-secondary-medium border border-default-medium text-heading text-sm rounded-2xl focus:ring-brand focus:border-brand shadow-xs placeholder:text-body"
                  placeholder="write your message here........"
                  required
                />
              </div>
            </form>
            <p className=" text-sm w-67 text-center m-3">
              Write your message here to get in touch give recommendation our
              website
            </p>
          </div>
