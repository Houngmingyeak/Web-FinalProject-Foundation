...
//             <a href="#" className="hover:text-black dark:hover:text-white transition">Feature</a>
//             <a href="#" className="hover:text-black dark:hover:text-white transition">Testimonials</a>
...
//           <Link to="/login" className="hidden lg:flex items-center bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-xl text-sm font-semibold transition shadow-sm">
//             Login
//           </Link>
//           <Link to="/signup" className="hidden lg:flex items-center bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-xl text-sm font-semibold transition shadow-sm">
//             Sign Up
//           </Link>
