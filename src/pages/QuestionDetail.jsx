      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between gap-2 flex-wrap">
                        <div className="text-xs text-gray-400 dark:text-gray-500">
                          ...
                          •{" "}
                          {formatDistanceToNow(new Date(answer.creationDate), {
                            addSuffix: true,
                          })}
                        </div>
                        {answerVote.voteId && (
        ...
        {currentUser ? (
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 shadow-sm p-6 sm:p-8">
            <h2 className="text-xl font-black mb-5 flex items-center gap-2">
              <FiEdit2 className="text-black-500" /> Your Answer
            </h2>
            ...
            <form onSubmit={handlePostAnswer} className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  minLength={5}
                  maxLength={500}
                  className="w-full min-h-32 px-4 py-3 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white text-sm  transition-all resize-none"
                />
              ...
              <div>
                ...
                <textarea
                  ...
                  disabled={submittingAnswer}
                  className="w-full min-h-24 px-4 py-3 bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-gray-900 dark:text-white font-mono text-sm  transition-all resize-none"
                />
              </div>
              <button
                type="submit"
                disabled={submittingAnswer || !answerContent.trim()}
                className="flex items-center gap-2 px-6 py-3 bg-blue-500 text-white font-bold rounded-xl transition-all hover:-translate-y-0.5 active:scale-95 disabled:opacity-50 disabled:translate-y-0 "
              >
                {submittingAnswer ? (
                  <>
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-8 text-center">
            ...
            <Link
              to="/login"
              className="inline-block px-6 py-3 bg-blue-500  text-white font-bold rounded-xl transition-all shadow-lg shadow-orange-500/20"
            >
              Log In to Answer
            </Link>
          </div>
